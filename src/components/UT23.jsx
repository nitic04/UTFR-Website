    ...
    <div className='text-white'>
        ...
        <div className='bg-[#2657A3]'>
            ...
            <div className='flex justify-evenly px-5 pt-14 lg:py-10'>
                <div>
                    <h1 className='flex justify-center text-3xl lg:text-6xl font-bold'>1st Place Overall</h1>
                    <p className='flex justify-center text-xl pt-2'>New Hampshire 2023</p>
                </div>
                <div>
                    <h1 className='flex justify-center text-3xl lg:text-6xl font-bold'>5th Place Overall</h1>
                    <p className='flex justify-center text-xl pt-2'>Michigan 2023</p>
                </div>
                <div>
                    <h1 className='flex justify-center text-3xl lg:text-6xl font-bold'>6th Place Overall</h1>
