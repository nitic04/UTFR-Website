...
import CarCutout from '../../assets/HistoricCarPhotos/UT11/UT11-Cutout.png'
import OverviewImg from '../../assets/HistoricCarPhotos/UT11/2011-Car-1.png'
import CompImg1 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-1.jpg'
import CompImg2 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-4.jpg'
import CarouselImg1 from '../../assets/HistoricCarPhotos/UT11/2011-Car-2.jpg'
import CarouselImg2 from '../../assets/HistoricCarPhotos/UT11/2011-Car-3.jpg'
import CarouselImg3 from '../../assets/HistoricCarPhotos/UT11/2011-Car-4.jpg'
import CarouselImg4 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-2.jpg'
import CarouselImg5 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-3.jpg'
import CarouselImg6 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-5.jpg'
import CarouselImg7 from '../../assets/HistoricCarPhotos/UT11/2011-FSG-6.jpg'
...
const UT11 = () => {
    ...
    const teamMembers = [
        { name: "Michael Bakaic", specialization: "- Team Principal, Chassis, Suspension" },
        { name: "Amanda Santos", specialization: "- Team Manager" },
        { name: "Anna Vanek", specialization: "- Project Administrator" },
        { name: "Mark Prelich", specialization: "- Brakes & Drivetrain" },
        { name: "Harsoveet Singh", specialization: "- Electrical" },
        { name: "Pulasti Bandara", specialization: "- Engine" },        
    ];
  ...
  return (
    <div>
        ...
        <div className="h-screen bg-[#B6C1D0]">
            ...
            <h1 className="carTitle text-center text-[130px] md:text-[280px] font-bold text-white pt-[250px]">UT11</h1>
            ...
            <div className='grid space-y-8 md:space-y-0 md:grid-cols-3 pt-10 md:pt-5'>
                <div>
                    ...
                    <h2 className="text-center text-white text-3xl md:text-4xl font-bold">Honda TRX450</h2>
                </div>
                <div>
                ...
                <div>
                    ...
                    <h2 className="text-center text-white text-3xl md:text-4xl font-bold">140 km/h</h2>
                </div>
            </div>
            </Fade>
        </div>
        ...
        <div className='bg-[#303949] grid lg:grid-cols-2 text-white'>
            <div className='px-10 py-10 lg:px-24 lg:py-32'>
                ...
                <p>In 2011, the UT11 race car was developed, securing 47th place overall at Formula SAE Michigan and 15th place overall in Germany. The team received 1st place in the skidpad event at Formula Student Germany. This car had the stiffest chassis yet with 3700Nm-de at 26.8kg. The team's perforamnce highlights their dedication to innovation and excellence inspiring future successes for UTFR.</p>
                </Fade>
            </div>
        ...
        <div className='bg-[#062644] text-white'>
            ...
            <div className='grid lg:grid-cols-3 items-center pb-10'>
                <div className='px-10'>
                    ...
                    <h3 className='text-center pb-10 lg:pb-0 text-2xl font-bold'>47th Place Overall</h3>
                ...
                <div className='px-10'>
                    ...
                    <h3 className='text-center lg:pb-0 text-2xl font-bold'>15th Place Overall</h3>
                    <h3 className='text-center lg:pb-0 text-2xl font-bold'>1st Place Skidpad</h3>
                    </Fade>
                </div>
            </div>
            </Fade>
        ...
        <TeamMembersSimpleComponents teamMembers={teamMembers} year={"UT11"} />
            ...
            <div className='flex text-white justify-center pb-10'>
                <div className='w-[850px] pb-3 px-5'>
                    ...
                    <div className='flex border-b-2'>
                        ...
                        <p className='md:text-2xl py-5 ml-auto'>9,500 rpm</p>
                    </div>
                    <div className='flex border-b-2'>
                    ...
                    <div className='flex border-b-2'>
                        ...
                        <p className='md:text-2xl py-5 ml-auto'>140 km/h</p>
                    </div>
                    <div className='flex border-b-2'>
