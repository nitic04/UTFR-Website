...
const Footer = () => {
  return (
    <div className='w-full h-[60px] bg-black'>
      ...
      <h2 className='text-center pb-5 text-gray-300'> Made By: <a className="transition duration-200 hover:text-white" href="https://www.linkedin.com/in/niti-chaudhary-81913426b/">Niti Chaudhary</a></h2>
    </div>
  )
}
