  ...
  return (
    <div className='w-full h-[300px] bg-[#131212]'>
        <div className='flex justify-center pt-5'>
            <img alt="" src={Villa} style={{width: '180px'}} className='p-5'/>
            <img alt="" src={Skule} style={{width: '180px'}} className='p-5'/>
        </div>
        <div className='flex justify-center h-[75px]'>
            <img alt="" src={Ansys} className='p-5'/>
            <img alt="" src={AST} className='p-5'/>
            <img alt="" src={AtomsLab} className='p-5'/>
            <img alt="" src={Bosch} className='p-5'/>
            <img alt="" src={Emrax} className='p-5'/>
            <img alt="" src={Haas} className='p-5 scale-150'/>
            <img alt="" src={Molson} className='p-5 scale-150'/>
        </div>
        <div className='flex justify-center h-[75px]'>
            ...
            <img alt="" src={Altium} className='p-5'/>
