...
// DRIVERS
import DamianSisera from '../assets/TeamMembers/Drivers/DamianSisera.jpeg'
import AyrtonAntenucci from '../assets/TeamMembers/Drivers/AyrtonAntenucci.jpeg'
import SpencerBall from '../assets/TeamMembers/Drivers/SpencerBall.jpeg'
import KelvinCui from '../assets/TeamMembers/Drivers/KelvinCui.jpeg'
// MECHANICAL
  ...
  return (
    <div className='w-full h-[100%] text-white bg-[#181818]'> 
        ...
        <div className='h-full w-full about grid md:grid-cols-2 lg:grid-cols-4 px-3'>
          ...
          <div className='w-[100%] my-auto py-10'>
            <img src={AyrtonAntenucci} alt="team" className='my-auto mx-auto w-[90%]'/>
            <p className='personName'>Ayrton Antenucci</p>
          </div>
          <div className='w-[100%] my-auto py-10'>
            <img src={SpencerBall} alt="team" className='my-auto mx-auto w-[90%]'/>
