...
const Sponsors = () => {
  return (
    <div>
        ...
        <div className='text-white bg-[#131212] pb-10'>
        ...
        <div className='text-white bg-[#181818] py-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3'>
                ...
                <div className='p-10'>
                    <img src={MIE} alt="" className='py-5 px-24'/>
                    <div className='bg-[#636363]'>
                ...
                <div className='p-10'>
                    <img src={Skule} alt="" className='py-5 px-40'/>
                    <div className='bg-[#636363]'>
            ...
            <h1 className='flex justify-center text-6xl font-bold'>Platinum Sponsors</h1>
            <h1 className='flex justify-center text-6xl font-bold'>Gold Sponsors</h1>
            <h1 className='flex justify-center text-6xl font-bold'>Silver Sponsors</h1>
            <h1 className='flex justify-center text-6xl font-bold'>Bronze Sponsors</h1>
            <h1 className='flex justify-center text-6xl font-bold'>Affiliates</h1>
        </div>
